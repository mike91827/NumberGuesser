...
public class StartMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Guess The Combination!");
...
//when start button is clicked, then let tthem pick thte difficulty  
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // easy mode
        new NewJFrame(1).setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // medium mode
        new NewJFrame(2).setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        //hard mode
        new NewJFrame(3).setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        System.out.println("StartMenu.main()");
        //</editor-fold>
